...
VALUES
    ...
    ('Bob Johnson', 'bob.johnson@gmail.com', '0922222222', 2,
        true, 'AFTER_CHECKIN', 'PAID', 'NOVA', null, '2025-06-01T15:00:00'),

    ('Carol White', 'carol.white@gmail.com', '0933333333', 3,
        false, 'AFTER_CHECKIN', 'CANCEL', 'UKRPOSHTA', null, '2025-06-02T08:00:00'),

    ('David Brown', 'david.brown@gmail.com', '0944444444', 4,
        false, 'AFTER_CHECKIN', 'RETURNED', 'NOVA', 'Please call me to confirm that all products are in stock',
        '2025-06-04T10:00:00'),
    ...
    ('Frank Miller', 'frank.miller@gmail.com', '0966666666', 6,
        false, 'AFTER_CHECKIN', 'CANCEL', 'NOVA', 'Please send the product in a week, I am currently away',
        '2025-06-05T12:30:12'),

    ('Grace Wilson', 'grace.wilson@gmail.com', '0977777777', 7,
        true, 'AFTER_CHECKIN', 'RETURNED', 'UKRPOSHTA', ' ', '2025-06-07T09:45:52'),
    ...
    ('John Doe', 'test_user@gmail.com', '0999999999', 9,
        true, 'AFTER_CHECKIN', 'PAID', 'NOVA', null, '2025-05-01T20:00:00'),
