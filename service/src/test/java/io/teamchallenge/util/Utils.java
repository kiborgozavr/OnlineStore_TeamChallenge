...
public class Utils {
    ...
    public static ShortOrderResponseDto getShortOrderResponseDto() {
        return ShortOrderResponseDto.builder()
                ...
                .deliveryMethod(DeliveryMethod.COURIER.getTitle())
    ...
    public static OrderUpdateRequestDto getOrderUpdateRequestDtoNova() {
        return OrderUpdateRequestDto.builder()
                ...
                .address(AddressDto.builder()
                        ...
                        .city("Kyiv")
                        .build())
                .deliveryMethod(DeliveryMethod.NOVA.getTitle())
                .cartItems(List.of(getCartItemRequestDto()))
                .phoneNumber("1234567890")
                .email("test@mail.com")
                .comment("comment")
    ...
    public static OrderUpdateRequestDto getOrderUpdateRequestDtoCourier() {
        return OrderUpdateRequestDto.builder()
                .fullName("FirstName")
                .address(AddressDto.builder()
                        .addressLine("address line")
    ...
    public static OrderUpdateRequestDto getOrderRequestDtoCourierAlternativeProduct() {
        return OrderUpdateRequestDto.builder()
                .fullName("FirstName")
                .address(AddressDto.builder()
                        .addressLine("address line")
